...
- (void)loadFaceThemeItems:(NSArray<FaceThemeModel *>*)themeItems;
{
    ...
    int normalSelectedIndex = 0;//默认选中的空置
    ...
    [_scrollView setContentOffset:CGPointMake(self.frame.size.width * normalSelectedIndex, 0) animated:NO];
    [_panelBottomView loadfaceThemePickerSource:self.faceSources];
    [_panelBottomView normalSelected:normalSelectedIndex];
}
